...
This repository is a Claude Skill covering the Web Components headless component library for an AI coding agent.
...
```sh
git clone https://github.com/LilyDesignSystem/lily-design-system-web-components-headless-skill.git
```
